...
export default function DirectSignatureScreen({ route, navigation }: any) {
  ...
  const handleNextStep = () => {
    if (step === 1) {
      if (!formData.Telefono || !formData.CorreoPersonal || !formData.ContactoEmergencia || !formData.Parentesco || !formData.TelefonoEmergencia || !formData.AFPId) {
        ...
        {step === 1 && (
          <View style={styles.formContainer}>
            <View style={styles.inputGroup}>
              ...
              <TextInput style={styles.input} placeholder="987654321" placeholderTextColor="#64748b" keyboardType="phone-pad" value={formData.Telefono} onChangeText={(v) => setFormData({...formData, Telefono: v})} />
            </View>
            <View style={styles.inputGroup}>
              <Text style={styles.label}>Correo Personal *</Text>
              <TextInput style={styles.input} placeholder="juan@email.com" placeholderTextColor="#64748b" keyboardType="email-address" autoCapitalize="none" value={formData.CorreoPersonal} onChangeText={(v) => setFormData({...formData, CorreoPersonal: v})} />
            </View>
            
            <Text style={styles.sectionTitle}>En Caso de Emergencia</Text>
            <View style={styles.inputGroup}>
              <Text style={styles.label}>Nombre del Contacto *</Text>
              <TextInput style={styles.input} placeholder="Maria Perez" placeholderTextColor="#64748b" value={formData.ContactoEmergencia} onChangeText={(v) => setFormData({...formData, ContactoEmergencia: v})} />
            </View>
            <View style={{flexDirection: 'row', gap: 12}}>
              <View style={[styles.inputGroup, {flex: 1}]}>
                <Text style={styles.label}>Parentesco *</Text>
                <TextInput style={styles.input} placeholder="Esposa" placeholderTextColor="#64748b" value={formData.Parentesco} onChangeText={(v) => setFormData({...formData, Parentesco: v})} />
              </View>
              <View style={[styles.inputGroup, {flex: 1}]}>
                <Text style={styles.label}>Celular *</Text>
                <TextInput style={styles.input} placeholder="999888777" placeholderTextColor="#64748b" keyboardType="phone-pad" value={formData.TelefonoEmergencia} onChangeText={(v) => setFormData({...formData, TelefonoEmergencia: v})} />
              </View>
            </View>
